...
//                    console.log("length of children is: ");
//                    console.log($e.children('title').length);
...
//        console.log("in fn.tipsy");
//        console.log("it is in fn.tipsy!!!");
//        console.log(options);
