// Get JSON data
treeJSON = d3.json("interviewQuestions.json", function(error, treeData) {
    ...
    //baseSvg.insert("xmlns:xlink", "http://www.w3.org/1999/xlink");
...
//        console.log(url);
    ...
    function update(source) {
        ...
        nodeEnter.append("text")
            ...
            .text(function(d) {
//                console.log("the number of children for d is: ");
//                console.log(d._children.length);
                return d.name;
            })
            .style("fill-opacity", 0);

//        nodeEnter.append("original-title")
//            .text(function(d) {
//                return d.size;
//        });
...
//                return d._children ? d.name + " [+] " : d.name;
                return d.name;
            });
