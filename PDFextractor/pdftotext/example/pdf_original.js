...
// Initializing PDFJS_origin global object (if still undefined)
if (typeof PDFJS_origin === 'undefined') {
  (typeof window !== 'undefined' ? window : this).PDFJS_origin = {};
}

PDFJS_origin.version = '0.8.1291';
PDFJS_origin.build = '8863ee5';
 ...
 * limitations under the License.
 */
/* globals Cmd, ColorSpace, Dict, MozBlobBuilder, Name, PDFJS_origin, Ref, URL,
           Promise */
...
// The global PDFJS_origin object exposes the API
// In production, it will be declared outside a global wrapper
// In development, it will be declared here
if (!globalScope.PDFJS_origin) {
  globalScope.PDFJS_origin = {};
}

globalScope.PDFJS_origin.pdfBug = false;

PDFJS_origin.VERBOSITY_LEVELS = {
  errors: 0,
  warnings: 1,
  infos: 5
};
...
// end users.
function info(msg) {
  if (PDFJS_origin.verbosity >= PDFJS_origin.VERBOSITY_LEVELS.infos) {
...
// Non-fatal warnings.
function warn(msg) {
  if (PDFJS_origin.verbosity >= PDFJS_origin.VERBOSITY_LEVELS.warnings) {
...
var UNSUPPORTED_FEATURES = PDFJS_origin.UNSUPPORTED_FEATURES = {
  unknown: 'unknown',
  forms: 'forms',
...
var UnsupportedManager = PDFJS_origin.UnsupportedManager =
...
PDFJS_origin.isValidUrl = isValidUrl;
...
var PasswordResponses = PDFJS_origin.PasswordResponses = {
  NEED_PASSWORD: 1,
...
var Util = PDFJS_origin.Util = (function UtilClosure() {
  function Util() {}
...
var PageViewport = PDFJS_origin.PageViewport = (function PageViewportClosure() {
...
/**
 * Legacy support for PDFJS_origin Promise implementation.
 * TODO remove eventually
 */
var LegacyPromise = PDFJS_origin.LegacyPromise = (function LegacyPromiseClosure() {
...
PDFJS_origin.createBlob = function createBlob(data, contentType) {
...
PDFJS_origin.createObjectURL = (function createObjectURLClosure() {
  // Blob/createObjectURL is not available, falling back to data schema.
  var digits =
    'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=';

  return function createObjectURL(data, contentType) {
    if (!PDFJS_origin.disableCreateObjectURL &&
        typeof URL !== 'undefined' && URL.createObjectURL) {
      var blob = PDFJS_origin.createBlob(data, contentType);
...
PDFJS_origin.Annotation = Annotation;
...
var TextAnnotation = (function TextAnnotationClosure() {
  ...
  Util.inherit(TextAnnotation, InteractiveAnnotation, {
    ...
    getHtmlElement: function TextAnnotation_getHtmlElement(commonObjs) {
      ...
      image.src = PDFJS_origin.imageResourcesPath + 'annotation-' +
 ...
 * @var {number}
 */
PDFJS_origin.maxImageSize = (PDFJS_origin.maxImageSize === undefined ?
                      -1 : PDFJS_origin.maxImageSize);
 ...
 * @var {string}
 */
PDFJS_origin.cMapUrl = (PDFJS_origin.cMapUrl === undefined ? null : PDFJS_origin.cMapUrl);

/**
 * Specifies if CMaps are binary packed.
 * @var {boolean}
 */
PDFJS_origin.cMapPacked = PDFJS_origin.cMapPacked === undefined ? false : PDFJS_origin.cMapPacked;
 ...
 * @var {boolean}
 */
PDFJS_origin.disableFontFace = (PDFJS_origin.disableFontFace === undefined ?
                         false : PDFJS_origin.disableFontFace);
 ...
 * @var {string}
 */
PDFJS_origin.imageResourcesPath = (PDFJS_origin.imageResourcesPath === undefined ?
                            '' : PDFJS_origin.imageResourcesPath);
 ...
 * @var {boolean}
 */
PDFJS_origin.disableWorker = (PDFJS_origin.disableWorker === undefined ?
                       false : PDFJS_origin.disableWorker);
 ...
 * @var {string}
 */
PDFJS_origin.workerSrc = (PDFJS_origin.workerSrc === undefined ? null : PDFJS_origin.workerSrc);
 ...
 * @var {boolean}
 */
PDFJS_origin.disableRange = (PDFJS_origin.disableRange === undefined ?
                      false : PDFJS_origin.disableRange);
 ...
 * @var {boolean}
 */
PDFJS_origin.disableAutoFetch = (PDFJS_origin.disableAutoFetch === undefined ?
                          false : PDFJS_origin.disableAutoFetch);

/**
 * Enables special hooks for debugging PDF.js.
 * @var {boolean}
 */
PDFJS_origin.pdfBug = (PDFJS_origin.pdfBug === undefined ? false : PDFJS_origin.pdfBug);

/**
 * Enables transfer usage in postMessage for ArrayBuffers.
 * @var {boolean}
 */
PDFJS_origin.postMessageTransfers = (PDFJS_origin.postMessageTransfers === undefined ?
                              true : PDFJS_origin.postMessageTransfers);

/**
 * Disables URL.createObjectURL usage.
 * @var {boolean}
 */
PDFJS_origin.disableCreateObjectURL = (PDFJS_origin.disableCreateObjectURL === undefined ?
                                false : PDFJS_origin.disableCreateObjectURL);

/**
 * Controls the logging level.
 * The constants from PDFJS_origin.VERBOSITY_LEVELS should be used:
 * - errors
 * - warnings [default]
 * - infos
 * @var {number}
 */
PDFJS_origin.verbosity = (PDFJS_origin.verbosity === undefined ?
                   PDFJS_origin.VERBOSITY_LEVELS.warnings : PDFJS_origin.verbosity);
 ...
 *   object.
 */
PDFJS_origin.getDocument = function getDocument(source,
  ...
  workerInitializedPromise = new PDFJS_origin.LegacyPromise();
  workerReadyPromise = new PDFJS_origin.LegacyPromise();
...
var PDFDocumentProxy = (function PDFDocumentProxyClosure() {
  ...
  PDFDocumentProxy.prototype = /** @lends PDFDocumentProxy.prototype */ {
    ...
    getJavaScript: function PDFDocumentProxy_getJavaScript() {
      var promise = new PDFJS_origin.LegacyPromise();
    ...
    getMetadata: function PDFDocumentProxy_getMetadata() {
      ...
      promise.resolve({
        info: info,
        metadata: (metadata ? new PDFJS_origin.Metadata(metadata) : null)
      });
      return promise;
    },
    /**
...
var PDFPageProxy = (function PDFPageProxyClosure() {
  function PDFPageProxy(pageInfo, transport) {
    ...
    this.stats.enabled = !!globalScope.PDFJS_origin.enableStats;
  ...
  PDFPageProxy.prototype = /** @lends PDFPageProxy.prototype */ {
    ...
    getViewport: function PDFPageProxy_getViewport(scale, rotate) {
      ...
      return new PDFJS_origin.PageViewport(this.view, scale, rotate, 0, 0);
    },
    /**
...
var WorkerTransport = (function WorkerTransportClosure() {
  function WorkerTransport(workerInitializedPromise, workerReadyPromise,
    ...
    this.pageCache = [];
    this.pagePromises = [];
    this.downloadInfoPromise = new PDFJS_origin.LegacyPromise();
    ...
    if (!globalScope.PDFJS_origin.disableWorker && typeof Worker !== 'undefined') {
      var workerSrc = PDFJS_origin.workerSrc;
      if (!workerSrc) {
        error('No PDFJS_origin.workerSrc specified');
      }
      ...
      try {
        ...
        messageHandler.on('test', function transportTest(data) {
          ...
          if (supportTypedArray) {
            ...
            if (!data.supportTransfers) {
              PDFJS_origin.postMessageTransfers = false;
            }
            this.setupMessageHandler(messageHandler);
            workerInitializedPromise.resolve();
          } else {
            globalScope.PDFJS_origin.disableWorker = true;
        ...
        var testObj = new Uint8Array([PDFJS_origin.postMessageTransfers ? 255 : 0]);
  ...
  WorkerTransport.prototype = {
    ...
    loadFakeWorkerFiles: function WorkerTransport_loadFakeWorkerFiles() {
      if (!PDFJS_origin.fakeWorkerFilesLoadedPromise) {
        PDFJS_origin.fakeWorkerFilesLoadedPromise = new LegacyPromise();
        // In the developer build load worker_loader which in turn loads all the
        // other files and resolves the promise. In production only the
        // pdf.worker.js file is needed.
        Util.loadScript(PDFJS_origin.workerSrc, function() {
          PDFJS_origin.fakeWorkerFilesLoadedPromise.resolve();
        });
      }
      return PDFJS_origin.fakeWorkerFilesLoadedPromise;
    },
    ...
    setupFakeWorker: function WorkerTransport_setupFakeWorker() {
      ...
      PDFJS_origin.WorkerMessageHandler.setup(messageHandler);
    },
    ...
    fetchDocument: function WorkerTransport_fetchDocument(source) {
      source.disableAutoFetch = PDFJS_origin.disableAutoFetch;
      source.chunkedViewerLoading = !!this.pdfDataRangeTransport;
      this.messageHandler.send('GetDocRequest', {
        source: source,
        disableRange: PDFJS_origin.disableRange,
        maxImageSize: PDFJS_origin.maxImageSize,
        cMapUrl: PDFJS_origin.cMapUrl,
        cMapPacked: PDFJS_origin.cMapPacked,
        disableFontFace: PDFJS_origin.disableFontFace,
        disableCreateObjectURL: PDFJS_origin.disableCreateObjectURL,
        verbosity: PDFJS_origin.verbosity
      });
    },
    ...
    getPage: function WorkerTransport_getPage(pageNumber, promise) {
      if (pageNumber <= 0 || pageNumber > this.numPages ||
        ...
        var pagePromise = new PDFJS_origin.LegacyPromise();
...
var RenderTask = (function RenderTaskClosure() {
  function RenderTask(internalRenderTask) {
     ...
     * @type {Promise}
     */
    this.promise = new PDFJS_origin.LegacyPromise();
  }
...
var InternalRenderTask = (function InternalRenderTaskClosure() {
  ...
  InternalRenderTask.prototype = {
    ...
    initalizeGraphics:
      ...
      if (PDFJS_origin.pdfBug && 'StepperManager' in globalScope &&
...
var Metadata = PDFJS_origin.Metadata = (function MetadataClosure() {
...
PDFJS_origin.disableFontFace = false;

var FontLoader = {
  insertRule: function fontLoaderInsertRule(rule) {
    var styleElement = document.getElementById('PDFJS_origin_FONT_STYLE_TAG');
    if (!styleElement) {
      styleElement = document.createElement('style');
      styleElement.id = 'PDFJS_origin_FONT_STYLE_TAG';
...
var FontFace = (function FontFaceClosure() {
  ...
  FontFace.prototype = {
    bindDOM: function FontFace_bindDOM() {
      ...
      if (PDFJS_origin.disableFontFace) {
      ...
      if (PDFJS_origin.pdfBug && 'FontInspector' in globalScope &&
...
if (!PDFJS_origin.workerSrc && typeof document !== 'undefined') {
  // workerSrc is not set -- using last script url to define default location
  PDFJS_origin.workerSrc = (function () {
    'use strict';
